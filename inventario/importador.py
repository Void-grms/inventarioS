"""Lógica de importación del inventario desde un .xlsx.

Reutilizable desde el management command (`importar_excel`) y desde la vista web
de importación. Acepta una ruta de archivo o un objeto tipo archivo (file-like).
"""
...
def importar_inventario(origen):
    """Importa bienes desde `origen` (ruta o file-like). Devuelve (creados, actualizados)."""
